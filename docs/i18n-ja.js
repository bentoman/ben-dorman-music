(() => {
  ...
  text('.featured-video .video-copy > p:not(.kicker):not(.video-note)', '『Emma Amazing & the Bucket Fillers』オリジナル・キャスト録音のアニメーション作品。');
  ...
  text('.philosophy p', '「まず、たった一人の演者の心に届くことを目指しています。若い演者に開かれた機会の窓は、やがて閉じてしまう。だからこそ、その窓から音楽を通して素晴らしい景色を見てほしい。そして、その経験を舞台の先にまで持っていってほしいのです。」');
